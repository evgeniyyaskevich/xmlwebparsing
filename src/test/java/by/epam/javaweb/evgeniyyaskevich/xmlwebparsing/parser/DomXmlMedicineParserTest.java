...
public class DomXmlMedicineParserTest {

    private static DomXmlMedicineParser domXmlMedicineParser= new DomXmlMedicineParser();
    ...
    public void parse() throws FileNotFoundException, InvalidInputStreamException,
        ...
        List<Medicine> result = domXmlMedicineParser.parse(new FileInputStream(file));
